const data = [
    ...
    {
        text:"What HTML element describes a block of a webpage?",
        buttons: [
    ...
    {
        text:"Which HTML version is currently in use?",
        buttons: [
    ...
    {
        text:"Which HTML semantic element would you choose to describe the news on the site?",
        buttons: [
    ...
    {
        text:"What is the default display value of an HTML a element?",
        buttons: [ //nete raso arba inline arba block default yra
            {buttont: "inline", buttonid: false},
    ...
    {
        text:"Which code correctly describes a row in an HTML table?",
        buttons: [
    ...
    {       //translation might be a little bit off
        text:"What unit of CSS is used to fit an HTML block to the width of the screen?",
        buttons: [ 
    ...
    {
        text:"Why are CSS called cascading styles?",
        buttons: [
    ...
    {
        text:"Which selector is correct for applying style to pdf files only?",
        buttons: [ //no clue katras teisingas :| gal reikes pridet kad nera teisingu atsakymu *shrug*
            {buttont: "a[href >='.pdf']", buttonid: false},
            {buttont: "a[href $='.pdf']", buttonid: true},
            {buttont: "a[href only ='.pdf']", buttonid: false},
            {buttont: "a[href='.pdf']", buttonid: false} 
        ]
    },
    {
        text:"Which class must be assigned to an HTML block in order for it to occupy 5 columns in the Bootstrap grid, omitting one column?",
    ...
    {
        text:"How to assign url described in the nav block list to a variable whose name is url?",
    ...
    {
        text:"Which of the variables are arrays?",
    ...
    {
        text:"How do I change the background color of a variable in the header to which the HTML element header is assigned using JavaScript?",
        buttons: [
    ...
    {       //pls find correct answer cus i cant be bothered with this sorriukas :P xd
        text:"How to create a new li element in an existing ul element that has a class preferences?",
        buttons: [ //BLET nu naxui tas javascript i swear to god php god programming language hehe wordpress ez 
            ...
            {buttont: "var list = document.querySelector('ul .preferences'); var listItem = document.createElement('li'); list.appendChild(listItem)", buttonid: true},
